...
_DP_CRUISE_MIN_V_NORMAL = [-2.3, -1.8, -1.6, -1.4, -1.2]
...
_DP_CRUISE_MAX_V_ECO = [1.4, 1.3, 1.0, 0.8, 0.4]
_DP_CRUISE_MAX_V_NORMAL = [1.5, 1.4, 1.1, 1.0, 0.6]
_DP_CRUISE_MAX_V_SPORT = [1.6, 1.5, 1.3, 1.1, 0.8]
